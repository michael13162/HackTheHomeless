                    ...
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                final int homelessId = Integer.parseInt(response.get("spenderId").toString());
                                for (int i = 0; i < purchases.length(); i++) {
                                    ...
                                    amountText.setText(String.format("%.2f", Double.parseDouble(purchase.get("amount").toString())));
                                ...
                                donateButton.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        try {
                                            ...
                                            JSONObject jsonObject = new JSONObject("{\"email\":\"" + GlobalApplicationProperties.email + "\", \"password\":\"" + GlobalApplicationProperties.password + "\", \"spenderId\":\"" + homelessId +"\", \"amount\":" + donationAmount +"}");
                                        ...
                                        new Response.Listener<JSONObject>() {
                                            ...
                                            public void onResponse(JSONObject response) {
                                                try {
                                                    ...
                                                    String balance = String.format("%.2f", Double.parseDouble(response.get("balance").toString()));
